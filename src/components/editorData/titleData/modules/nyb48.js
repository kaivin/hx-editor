...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'', // PC端样式
        styleWapCode:'.smalltit048{text-align:center}.smalltit048 strong{display:inline-block;position:relative;border-radius:.42667rem;background:#ffc0cb;padding:0rem 0rem .10667rem 0rem}.smalltit048 strong span{clear:both;display:block;background:#ffc0cb;color:#fff;padding:.06667rem .26667rem;border-radius:50px;box-shadow:0 .05333125rem 0 #fff;font-size:.4rem;line-height:1.5}', // 移动端样式
