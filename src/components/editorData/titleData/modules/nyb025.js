...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltit025{text-align:center;}.smalltit025 strong{display:inline-block;padding:0px 15px;position:relative;font-weight:normal;}.smalltit025 strong:after, .smalltit025 strong:before{content:"";position:absolute;background:url(../images/insidestyle/small012.gif) no-repeat center center;width:38px;height:20px;top:50%;transform:translateY(-50%);}.smalltit025 strong:after{left:-40px;}.smalltit025 strong:before{right:-40px;}', // PC端样式
