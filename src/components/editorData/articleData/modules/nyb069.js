 ...
 * @LastEditTime: 2020-06-08 18:18:41
...
export function getHtmlData (){
    return {
        ...
        styleWapCode:'.smalltxt069{margin:.4rem 0} .smalltxt069 p{padding:0 0 .2rem .5333125rem;margin:0;position:relative} .smalltxt069 p:before{content:"";width:.29375rem;height:.29375rem;background:#97c7f7;border:.08rem solid #e4f2ff;border-radius:50%;display:block;position:absolute;left:0;top:.29375rem;box-sizing:border-box;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;} .smalltxt069 p:after{content:"";width:.0266875rem;background:#97c7f7;position:absolute;left:.12rem;top:.4rem;bottom:-.78rem} .smalltxt069 p:last-child{padding-bottom:0} .smalltxt069 p:last-child:after{display:none}', // 移动端样式
