export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt062{background:#e7f3ff;border-radius:10px;padding:20px;position:relative;max-width:800px;margin-left:auto;margin-right:auto;}.smalltxt062:before{content:"";border:1px dashed #2c83db;border-radius:10px;position:absolute;left:5px;right:5px;top:5px;bottom:5px;}', // PC端样式
