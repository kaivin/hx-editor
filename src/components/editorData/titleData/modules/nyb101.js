...
export function getHtmlData (){
    return {
        ...
        styleWapCode:'.smalltit101 strong{color:#272c38;font-size:.45333rem;position:relative;padding-bottom:.21333rem;padding-right:.13333rem}.smalltit101 strong:before{content:"";display:block;width:.18667rem;height:.18667rem;background-color:rgb(1,102,155);border-radius:50%;position:absolute;right:0;bottom:0}.smalltit101 strong:after{content:"";display:block;width:90%;height:.08rem;position:absolute;right:0;bottom:.05333rem;background-color:rgb(1,102,155);background-image:linear-gradient(90deg,rgb(255,255,255), rgb(1,102,155));}', // 移动端样式
