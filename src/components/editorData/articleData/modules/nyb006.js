export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt006{border:1px dashed #ccc;border-radius:5px;position:relative;padding:15px !important;margin-top:5px;box-shadow:5px -5px 0px #d6d6d67a;max-width:800px;margin-left:auto;margin-right:auto;}.smalltxt006:after{content:"";position:absolute;left:-7px;top:10px;width:14px;height:53px;background:url(../images/insidestyle/small016.gif) no-repeat right center #fff;}', // PC端样式
