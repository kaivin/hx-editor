...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltit035{clear:both;}.smalltit035 strong{display:inline-block;position:relative;border-radius:32px;padding:5px 15px;background:#de5252;color:#fff;font-size:18px;}.smalltit035 strong span{font-style:normal;border-radius:50%;text-align:center;padding-right:7px;}', // PC端样式
