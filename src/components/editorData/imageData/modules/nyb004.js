export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltext004{background:rgba(0, 165, 214, 0.18);padding:0px 20px 5px 20px;border-radius:10px;overflow:hidden;max-width:800px;margin-left:auto;margin-right:auto;}.smalltext004 strong{display:inline-block;position:relative;border-radius:0px 20px 20px 0px;padding:10px 20px;background:#00a5d6;color:#fff;line-height:1.4;margin-left:-20px;overflow:hidden;font-size:18px;}.smalltext004 p{margin:0px 0px 10px 0px;}', // PC端样式
        styleWapCode:'.smalltext004{background:rgba(0, 165, 214, 0.18);padding:0rem 0.2rem 0.2rem 0.2rem;border-radius:0.13333rem;overflow:hidden;font-size:0.38667rem;}.smalltext004 strong{display:inline-block;position:relative;border-radius:0rem 0.2rem 0.2rem 0rem;padding:0.13333rem 0.26667rem;background:#00a5d6;color:#fff;line-height:1.4;margin-left:-0.2rem;overflow:hidden;}', // 移动端样式
