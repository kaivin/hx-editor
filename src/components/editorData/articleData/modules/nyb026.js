export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt026{position:relative;border-radius:10px;border:1px dashed #a4e2c6;z-index:10;padding:10px 15px !important;max-width:800px;margin-left:auto;margin-right:auto;}.smalltxt026:before{content:"";border-radius:10px;position:absolute;left:5px;right:5px;bottom:5px;top:5px;background:#a4e2c6;z-index:-1;}', // PC端样式
