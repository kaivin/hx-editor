export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt055{background:#e0f2ff;color:#4e79bf;padding:15px 25px;position:relative;max-width:800px;margin-left:auto;margin-right:auto;}.smalltxt055:after, .smalltxt055:before{content:"";width:5px;background:#94c6f7;border-radius:3px;position:absolute;left:0;top:-3px;bottom:-3px;}.smalltxt055:after{left:auto;right:0;}', // PC端样式
