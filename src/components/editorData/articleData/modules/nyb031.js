export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt031{border:1px solid #bcd0f5;padding:15px 20px;border-radius:30px 0 30px 0;position:relative;color:#4068ac;}.smalltxt031:after{content:"";position:absolute;border-radius:30px 0 30px 0;border:1px dashed #bcd0f5;left:5px;top:5px;right:5px;bottom:5px;}', // PC端样式
