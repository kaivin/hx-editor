export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt038{color:#3a4f9f !important;background:#fff;border:1px solid #bcd0f5;border-radius:10px;padding:12px 15px;box-shadow:5px 5px 0 #bcd0f5;max-width:800px;margin-left:auto;margin-right:auto;}', // PC端样式
