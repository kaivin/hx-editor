export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt036{color:#3a4f9f !important;border:1px solid #bcd0f5;border-radius:10px;padding:20px 20px 0px 0px;position:relative;z-index:2;max-width:800px;margin-left:auto;margin-right:auto;}.smalltxt036:before{content:"";background:#bcd0f5;border-radius:10px;position:absolute;left:-10px;top:10px;right:10px;bottom:-10px;z-index:-1;}', // PC端样式
