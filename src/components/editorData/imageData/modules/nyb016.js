export function getHtmlData (){
    return {
        ...
        styleWapCode:'.smalltext016{background:#fff;padding:0rem 0.4rem 0.26667rem;border-radius:0.2rem;box-shadow:0 2px 2px #bfcad6;position:relative;}.smalltext016:before{content:"";width:100%;height:0.2rem;background:#5a8ccf;display:block;border-radius:0.2rem 0.2rem 0 0;position:absolute;left:0;top:0px;}.smalltext016 span{width:fit-content;background:#5a8ccf;display:block;text-align:center;color:#fff;line-height:2;text-indent:0;margin:0 auto 0.16rem auto;padding:0rem 0.4rem;border-radius:0rem 0rem 0.2rem 0.2rem;position:relative;}', // 移动端样式
