...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltable019{ clear: both; display: block; margin:30px 0px;}.smalltable019 table {width: 100%;border-collapse: collapse;border: 0px;background: #fff;}.smalltable019 table td{padding: 10px 0px;border: 1px solid #dcdcdc;text-align: center;word-break: break-all; font-size: 16px;}.smalltable019 table tr:nth-child(odd) td{background: #ebfeff;}.smalltable019 table tr td:first-child{background: #2b6b70; color: #fff; border-bottom:1px solid #59649a;}        .smalltable019 table tr:last-child td:first-child{border-bottom:1px solid #dcdcdc;}@media screen and (max-width: 1600px){.smalltable019{clear:both; margin:26px 0px;}.smalltable019 table td{font-size:15px !important;padding: 14px 15px !important;}}@media screen and (max-width: 1440px){.smalltable019{clear:both; margin:24px 0px;}.smalltable019 table td{padding: 12px 15px !important;}}@media screen and (max-width: 1280px){.smalltable019{clear:both; margin:20px 0px;}.smalltable019 table td{font-size:14px !important;padding: 10px 15px !important;}}', // PC端样式
        styleWapCode:'.smalltable019{ clear: both; display: block; margin: .33333rem 0rem;}.smalltable019 table {width: 100%;border-collapse: collapse;border: 0px;background: #fff;}.smalltable019 table td{padding:0.133333rem 0.13333rem;border: 1px solid #dcdcdc;text-align: center;word-break: break-all;font-size: .37333rem; line-height:0.64rem;}.smalltable019 table tr:nth-child(odd) td{background: #ebfeff;}.smalltable019 table tr td:first-child{background: #2b6b70; color: #fff; border-bottom:1px solid #59649a;}.smalltable019 table tr:last-child td:first-child{border-bottom:1px solid #dcdcdc;}', // 移动端样式
