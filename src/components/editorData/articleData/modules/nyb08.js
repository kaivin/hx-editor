...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt008{position:relative; border-color:#99c4d0; border-style:solid; border-width:5px 1px; padding:10px 15px !important; margin-bottom:20px;}', // PC端样式
