export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt058{background:#e9f6ff;border:2px solid #97c7f7;padding:15px;text-align:left;position:relative;z-index:1;margin-left:auto;margin-right:auto;}', // PC端样式
