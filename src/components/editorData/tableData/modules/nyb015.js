...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltable015{clear:both; margin:20px 0px;}.smalltable015 .smalltable015tit{clear: both; display: block;padding: 10px 10px !important; background:#2b6b70;color: #fff !important;font-size: 28px !important;line-height: 48px !important; text-align: center; margin: 0px!important;font-weight:bold;}.smalltable015 table{margin: 0 auto;width: 100%; background: #fff; border-collapse: collapse;}.smalltable015 table tr{border:1px solid #dcdcdc;}.smalltable015 table td{padding:15px 15px;word-break: break-all; border:1px solid #dcdcdc; text-align: center;  line-height:24px; font-size:16px; color: #333;}.smalltable015 table th{padding:15px 15px;word-break: break-all; border:1px solid #dcdcdc; text-align: center;  line-height:24px; font-size:16px; background: #f8ffff; font-weight: bold; color: #333;}', // PC端样式
        styleWapCode:'.smalltable015{clear:both;margin:.26667rem 0rem}.smalltable015 .smalltable015tit{clear:both;display:block;background:#2b6b70;color:#fff;font-size:.37333rem;line-height:.4rem;padding:.26667rem .2rem;text-align:center;margin:0px !important;font-weight:bold}.smalltable015 table{margin:0 auto;width:100%;background:#fff;border-collapse:collapse}.smalltable015 table tr{border:1px solid #dcdcdc}.smalltable015 table td{padding:.2rem .13333rem;word-break:break-all;border:1px solid #dcdcdc;text-align:center;line-height:.66667rem;font-size:.32rem;color:#333}.smalltable015 table th{padding:.2rem .13333rem;word-break:break-all;border:1px solid #dcdcdc;text-align:center;line-height:.66667rem;font-size:.34667rem;background:#f8ffff;font-weight:bold;color:#333}', // 移动端样式
