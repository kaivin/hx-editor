export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt001{border:1px solid #bdbdbd;box-shadow:0px 0px 6px #dddcdb inset, 0px 0px 6px #dddcdb;padding:15px !important;max-width:800px;margin-left:auto;margin-right:auto;}', // PC端样式
