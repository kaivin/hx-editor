...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltit040{display:block;text-align:center;}.smalltit040 strong{position:relative;line-height:1.5;color:#fff;border-radius:4px;padding:10px 20px;display:inline-block;background:#b72630;font-size:18px;}.smalltit040 strong:after{content:"";position:absolute;top:4px;left:4px;bottom:4px;right:4px;border:1px dashed #fff;border-radius:4px;box-sizing:border-box;}', // PC端样式
