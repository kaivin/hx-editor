...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt053{background:rgb(199,237,251)!important;padding:25px;position:relative;margin-left:auto;margin-right:auto;}.smalltxt053:after,.smalltxt053:before{content:"";width: 65px;height: 35px;background:url(../images/insidestyle/small036.png) no-repeat;background-size:100%;display:block;position:absolute;}.smalltxt053:before{left: 0px;top: 0px;}.smalltxt053:after{right: 0px;bottom: 0px;transform:rotate(180deg);-ms-transform:rotate(180deg);-moz-transform:rotate(180deg);-webkit-transform:rotate(180deg);-o-transform:rotate(180deg);}', // PC端样式
        styleWapCode:'.smalltxt053{background:rgb(199,237,251)!important;padding:0.13333rem 0.26667rem;position:relative;margin:0.66667rem 0.13333rem !important;}.smalltxt053:after,.smalltxt053:before{content:"";width:1.24rem;height:0.65333rem;background:url(../images/insidestyle/small036.png) no-repeat;background-size:100%;display:block;position:absolute;}.smalltxt053:before{left:-0.13333rem;top:-0.13333rem;}.smalltxt053:after{right:-0.13333rem;bottom:-0.13333rem;transform:rotate(180deg);-ms-transform:rotate(180deg);-moz-transform:rotate(180deg);-webkit-transform:rotate(180deg);-o-transform:rotate(180deg);}', // 移动端样式
