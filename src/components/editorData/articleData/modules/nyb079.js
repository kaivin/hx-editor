export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt079{clear:both;display:block;background:url(../images/insidestyle/smalltxt075_icon01.gif) repeat left top;border: 1px solid rgb(2,143,199);position: relative;background: #fff;border-radius: 15px;padding: 25px 20px 26px 20px;}.smalltxt079:after{content: "";position: absolute;left: -1px;right: -1px;bottom: 15px;border: 1px solid rgb(2,143,199);border-radius: 15px;display: block;top: -1px;}.smalltxt079:before{content: "";position: absolute;right: 40px;bottom: -1px;border: 1px solid rgb(2,143,199);border-radius: 50%;display: block;background: rgb(199,237,251);width: 18px;height: 18px;}.smalltxt079 strong{background: rgb(199,237,251);border: 1px solid rgb(2,143,199);padding: 8px 20px;color: rgb(0,86,133);display: inline-block;border-radius: 27px;font-size: 18px;}', // PC端样式
        styleWapCode:'.smalltxt079{clear:both;display:block;background:url(../images/insidestyle/smalltxt075_icon01.gif) repeat left top;border:1px solid rgb(2,143,199);position:relative;background:#fff;border-radius:0.2667rem;padding: 0.4rem 0.2667rem 0.3333rem 0.2667rem;}.smalltxt079:after{content: "";position: absolute;left: -1px;right: -1px;bottom: 0.2rem;border: 1px solid rgb(2,143,199);border-radius: 0.2667rem;display: block;top: -1px;}.smalltxt079:before{content: "";position: absolute;right: 0.5333rem;bottom: 0rem;border: 1px solid rgb(2,143,199);border-radius: 0.2667rem;display: block;background: rgb(199,237,251);width: 0.2267rem;height: 0.2267rem;}.smalltxt079 strong{background: rgb(199,237,251);border: 1px solid rgb(2,143,199);padding: 0.1333rem 0.2667rem;color: rgb(0,86,133);display: inline-block;border-radius: 0.5333rem;}', // 移动端样式
