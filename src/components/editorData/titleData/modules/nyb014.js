...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltit014{background:url(../images/insidestyle/newicon14.png) no-repeat left 7px;padding-top:0px;padding-bottom:0px;padding-left:30px;background-size:20px;}', // PC端样式
