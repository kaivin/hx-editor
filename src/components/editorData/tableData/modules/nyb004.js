...
export function getHtmlData (){
    return {
        ...
        styleWapCode:'  .smalltable004{clear:both;margin: .26667rem 0rem;}.smalltable004 table{margin: 0 auto;width: 100%; background: #fff; border-collapse: collapse;}.smalltable004 table tr:nth-child(odd) td{background: #faf9f1;font-size: 0.37333rem;color: #181412;}.smalltable004 table tr td{border:1px solid #f1eedc;padding: 0.15rem 0.26667rem;font-size: 0.32rem;color: #3c3733;text-align: left;}', // 移动端样式
