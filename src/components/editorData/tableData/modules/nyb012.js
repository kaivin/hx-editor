...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltable012{ clear: both; display: block; margin:30px 0px;}.smalltable012 table {width: 100%;border-collapse: collapse;border: 0px;background: #fff;}.smalltable012 table td{padding: 10px 0px;border:1px solid #f1ebeb;text-align: center;word-break: break-all; font-size: 16px;}.smalltable012 table tr:nth-child(odd) td{background:#fff7f7;}.smalltable012 table tr td:first-child{background: #bb1c19;background: -o-linear-gradient(left, #ca1e1c, #ee4545);background: -webkit-gradient(linear, left top, right top, from(#ca1e1c), to(#ee4545));background: linear-gradient(to right, #ca1e1c, #ee4545); color: #fff; border-bottom:1px solid #da6666;}.smalltable012 table tr:last-child td:first-child{border-bottom:1px solid #f1ebeb;}@media screen and (max-width: 1600px){.smalltable012{clear:both; margin:26px 0px;}.smalltable012 table td{font-size:15px !important;padding: 14px 15px !important;}}@media screen and (max-width: 1440px){.smalltable012{clear:both; margin:24px 0px;}.smalltable012 table td{padding: 12px 15px !important;}}@media screen and (max-width: 1280px){.smalltable012{clear:both; margin:20px 0px;}.smalltable012 table td{font-size:14px !important;padding: 10px 15px !important;}}', // PC端样式
        styleWapCode:'.smalltable012{ clear: both; display: block; margin: .33333rem 0rem;}.smalltable012 table {width: 100%;border-collapse: collapse;border: 0px;background: #fff;}.smalltable012 table td{padding:0.133333rem 0.13333rem;border:1px solid #f1ebeb;text-align: center;word-break: break-all;font-size: .37333rem; line-height:0.64rem;}.smalltable012 table tr:nth-child(odd) td{background:#fff7f7;}.smalltable012 table tr td:first-child{background: #bb1c19;background: -o-linear-gradient(left, #ca1e1c, #ee4545);background: -webkit-gradient(linear, left top, right top, from(#ca1e1c), to(#ee4545));background: linear-gradient(to right, #ca1e1c, #ee4545); color: #fff; border-bottom:1px solid #da6666;}.smalltable012 table tr:last-child td:first-child{border-bottom:1px solid #f1ebeb;} ', // 移动端样式
