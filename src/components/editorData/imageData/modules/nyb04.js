...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltext004 {background:rgba(0, 165, 214, 0.18);padding:0px 15px;border-radius:10px;overflow:hidden;margin-bottom:20px!important;}.smalltext004 strong {display:inline-block;position:relative;border-radius:0px 10px 10px 0px;padding:5px 15px;background:#00a5d6;color:#fff;margin-left:-15px;overflow:hidden;font-size:18px;margin-bottom:10px;}', // PC端样式
