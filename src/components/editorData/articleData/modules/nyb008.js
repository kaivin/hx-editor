export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt008{position:relative;padding:15px !important;border-color:#99c4d0;border-style:solid;border-width:5px 1px;max-width:800px;margin-left:auto;margin-right:auto;}', // PC端样式
