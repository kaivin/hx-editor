...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltit080{position:relative;z-index:1;}.smalltit080 strong{display:inline-block;border-radius:30px;padding:8px 20px;line-height:30px;position:relative;background:#bacac6;color:#fff;font-size:18px;}', // PC端样式
