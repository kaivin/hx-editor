...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'', // PC端样式
        styleWapCode:'.smalltit072{clear:both;display:block;position:relative;text-align:left}.smalltit072 strong{clear:both;display:inline-block;position:relative;padding-bottom:.26667rem}.smalltit072 strong:after,.smalltit072 strong:before{content:"";height:.06667rem;display:block;position:absolute;left:0}.smalltit072 strong:before{width:30%;background:#b25d25;bottom:.13333rem}.smalltit072 strong:after{width:60%;background:#ffe6d5;bottom:0rem}', // 移动端样式
