export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt054{clear:both;border:2px solid #e0f2ff;padding: 11px 15px 10px 15px;position:relative;margin-left:auto;margin-right:auto;margin-top: 30px!important;}.smalltxt054:before{content:"";width:100%;height: 10px;background: url(../images/insidestyle/small037.png) repeat;background-size: 40px 10px;display:block;position:absolute;left:0;top: -10px;}.smalltxt054:after{content:"";height:1px;background:#e0f2ff;position:absolute;left:15px;right:15px;top: 10px;}.smalltxt054 p{margin: 5px 0px!important;}', // PC端样式
