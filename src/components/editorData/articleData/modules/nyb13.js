...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt013 {position:relative;border-radius:10px;border:1px dashed #f6b37f;z-index:10;padding:10px 15px !important;margin-bottom:20px!important;}.smalltxt013:before {content:"";border-radius:10px;position:absolute;left:5px;right:5px;bottom:5px;top:5px;background:#ffeada;z-index:-1;}', // PC端样式
