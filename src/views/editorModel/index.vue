...
export default {
  ...
  beforeCreate:function(){
    ...
    this.$nextTick(function () {
      this.titleData = modulesTitleData.reverse();
      this.articleData = modulesArticleData.reverse();
      this.imageData = modulesImageData.reverse();
      this.buttonData = modulesButtonData.reverse();
      this.tableData = modulesTableData.reverse();
      this.videoData = modulesVideoData.reverse();
    });
  },
  computed:{
      ...mapGetters([
