export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt039{color:#3a4f9f !important;background:#fff;border:1px solid #bcd0f5;border-radius:10px;padding:12px 15px;box-shadow:0 5px 0 #bcd0f5;max-width:800px;margin-left:auto;margin-right:auto;}.smalltxt039 p{margin:0 !important;text-indent:0 !important;padding:0 10px;}', // PC端样式
