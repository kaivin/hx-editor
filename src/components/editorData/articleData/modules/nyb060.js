export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt060{border:1px solid #88bff2;border-radius:10px;border-bottom:5px solid #88bff2;padding:15px;max-width:800px;margin-left:auto;margin-right:auto;}', // PC端样式
