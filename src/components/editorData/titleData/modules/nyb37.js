...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltit037 {clear:both;text-align:center !important;color:#a01f31 !important;font-weight:bold;padding-bottom:20px !important;font-size:18px !important;}.smalltit037::before, .smalltit037::after {content:"";display:inline-block;vertical-align:middle;}.smalltit037::before {background:url(../images/insidestyle/small018.png) no-repeat;width:48px;height:39px;background-size:100%;margin-right:15px;}.smalltit037::after {background:url(../images/insidestyle/small019.png) no-repeat;width:30px;height:39px;background-size:100%;margin-left:15px;}.smalltit037 a {color:#f00 !important;}', // PC端样式
