export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt023{background:#ffe7eb;border-radius:10px;padding:12px 15px;position:relative;max-width:800px;margin-left:auto;margin-right:auto;}.smalltxt023:before{content:"";border:1px solid #ffe7eb;border-radius:10px;position:absolute;left:10px;top:-10px;right:10px;bottom:-10px;}', // PC端样式
