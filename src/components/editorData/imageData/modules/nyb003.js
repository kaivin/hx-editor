...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltext003{padding:0px 20px 20px 20px;border-radius:10px;border:1px solid rgb(1,102,155)!important;position:relative;max-width:800px;margin-left:auto;margin-right:auto;margin-top:50px;}.smalltext003 strong{display:block;text-align:center;border-radius:30px;padding:10px 20px;background:rgb(1,102,155)!important;font-size: 18px;color:#fff!important;line-height: 1.5;margin-top:-24px;margin-bottom: 15px;}.smalltext003 p{margin: 0!important;}', // PC端样式
        styleWapCode:'.smalltext003{padding:0rem 0.4rem 0.26667rem 0.4rem;border-radius:0.13333rem;border:1px solid rgb(1,102,155)!important;position:relative;margin-top:0.8rem;font-size:0.38667rem;}.smalltext003 strong{display:block;text-align:center;border-radius:0.4rem;padding:0.13333rem 0.26667rem;background:rgb(1,102,155)!important;font-size: 0.4rem;color:#fff!important;line-height:1.4;margin-top:-0.4rem;margin-bottom:0.2rem;}.smalltext003 p{margin: 0!important;}', // 移动端样式
