...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'', // PC端样式
        styleWapCode:'.smalltit086{clear:both;display:block;position:relative;text-align:left}.smalltit086 strong{clear:both;display:inline-block;position:relative;padding-bottom:.26667rem}.smalltit086 strong:after,.smalltit086 strong:before{content:"";height:.06667rem;display:block;position:absolute;left:0}.smalltit086 strong:before{width:30%;background:#cca4e3;bottom:.13333rem}.smalltit086 strong:after{width:60%;background:#eddff6;bottom:0rem}', // 移动端样式
