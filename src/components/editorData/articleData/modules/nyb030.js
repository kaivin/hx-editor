export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt030{position:relative;border-radius:10px;border:1px dashed #c83c23;z-index:10;padding:10px 15px !important;color:#fff !important;}.smalltxt030:before{content:"";border-radius:10px;position:absolute;left:5px;right:5px;bottom:5px;top:5px;background:#c83c23;z-index:-1;}', // PC端样式
