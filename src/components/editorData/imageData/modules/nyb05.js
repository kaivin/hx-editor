export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltext005 {padding:10px 15px 0px 15px;margin-bottom:20px!important;border-radius:10px;border:1px solid #ff461f;position:relative;}.smalltext005 strong {display:inline-block;padding:0px 0px 5px 0px;color:#ff461f;border-bottom:2px solid #ff461f;margin-bottom:5px;font-size:18px;}', // PC端样式
