...
export function getHtmlData (){
    return {
        ...
        styleWapCode:'.smalltit035{clear:both;}.smalltit035 strong{display:inline-block;position:relative;border-radius:0.42667rem;padding:0.04rem 0.2rem;background:#de5252;color:#fff!important;}.smalltit035 strong span{font-style:normal;border-radius:50%;text-align:center;padding-right:0.09333rem;}', // 移动端样式
