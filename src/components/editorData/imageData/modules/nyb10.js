...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltext010 {padding:20px 15px 0px;border-radius:10px;border:1px solid #fd9001;position:relative;margin-bottom:20px!important;margin-top:18px!important;}.smalltext010 strong {background:#fd9001;color:#fff;display:block;border-radius:18px;padding:5px 15px;line-height:24px;text-align:center;font-size:18px;position:absolute;left:50%;transform:translateX(-50%);top:-18px;}', // PC端样式
