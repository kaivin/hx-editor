 ...
 * @LastEditTime: 2020-06-08 18:10:00
...
export function getHtmlData (){
    return {
        ...
        class:'smalltxt028',// 用来给js使用添加页面内样式使用
        styleWebCode:'.smalltxt028{position:relative;border-radius:10px;border:1px dashed #955539;z-index:10;padding:10px 15px !important;color:#fff !important;}.smalltxt028:before{content:"";border-radius:10px;position:absolute;left:5px;right:5px;bottom:5px;top:5px;background:#955539;z-index:-1;}', // PC端样式
