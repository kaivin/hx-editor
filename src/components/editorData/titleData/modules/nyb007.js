...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltit007{background:url(../images/insidestyle/newicon07.png) no-repeat left 7px;padding-top:0px;padding-bottom:0px;padding-left:30px;background-size:20px;}', // PC端样式
