export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltext001 {background:#fff4e2;padding:15px 15px 0px 15px !important;border-radius:10px;margin-bottom:20px!important;}.smalltext001 strong {display:inline-block;position:relative;border-radius:10px;padding:10px 15px;background:#cc5510;color:#fff;line-height:1;overflow:hidden;font-size:18px;}', // PC端样式
