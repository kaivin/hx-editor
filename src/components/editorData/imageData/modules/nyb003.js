export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltext003{padding:0px 20px 20px 20px;border-radius:10px;border:1px solid #82cbef;position:relative;max-width:800px;margin-left:auto;margin-right:auto;margin-top:50px;}.smalltext003 strong{display:block;text-align:center;border-radius:30px;padding:10px 20px;background:#82cbef;color:#fff;line-height:1.4;margin-top:-24px;margin-bottom:10px;}', // PC端样式
