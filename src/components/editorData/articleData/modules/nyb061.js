export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt061{background:#f0f7fe;border-top:3px solid #97c7f7;border-bottom:3px solid #97c7f7;padding:15px;max-width:800px;margin-left:auto;margin-right:auto;}', // PC端样式
