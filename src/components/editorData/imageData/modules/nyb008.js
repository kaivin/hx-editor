export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltext008{background:#fff4e2;padding:20px 20px 20px 20px;border-radius:10px;position:relative;margin-top:24px;font-size:16px;max-width:800px;margin-left:auto;margin-right:auto;}.smalltext008 strong{display:inline-block;text-align:center;border-radius:30px;padding:10px 20px;background:#cc5510;color:#fff!important;line-height:1.4;font-size:18px;}.smalltext008 strong span{float:left;padding-right:10px;}.smalltext008 p{margin:10px 0px 0px 0px;}', // PC端样式
        styleWapCode:'.smalltext008{background: #fff4e2;padding: 0.26667rem 0.26667rem 0.26667rem 0.26667rem;border-radius: 0.13333rem;position: relative;font-size: 0.38667rem;}.smalltext008 strong{display: inline-block;text-align: center;border-radius: 0.4rem;padding: 0.13333rem 0.26667rem;background: #cc5510;color: #fff!important;line-height: 1.2;margin-bottom: 0.2rem;}.smalltext008 strong span{float: left;padding-right: 0.13333rem;}.smalltext008 p{margin:0rem 0rem 0rem 0rem;}', // 移动端样式
