...
export function getHtmlData (){
    return {
        ...
        styleWapCode:'.smalltable009{ clear: both; display: block; margin: .33333rem 0rem;}.smalltable009 table {width: 100%;border-collapse: collapse;border: 0px;background: #fff;}.smalltable009 table thead th {background:#8088b4; color: #fff;}.smalltable009 table thead th,.smalltable009 table tbody td{padding:0.133333rem 0.13333rem;border: 1px solid #dcdcdc;text-align: center;word-break: break-all;font-size: .37333rem; line-height:0.64rem;}.smalltable009 table tbody tr:nth-child(even) td{background: #e9ecf7;}', // 移动端样式
