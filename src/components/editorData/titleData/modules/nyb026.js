...
export function getHtmlData (){
    return{
        ...
        class:'smalltit026',// 用来给js使用添加页面内样式使用
        fileName:'nyb26.js', // 该文件的文件名
        styleWebCode:'.smalltit026{text-align:center;margin-top: 35px!important;font-size: 20px!important;}.smalltit026 strong{display:inline-block;padding:0px 15px;position:relative;}.smalltit026 strong:after{content:"";position:absolute;background:url(../images/insidestyle/small013.gif) no-repeat center center;width:41px;height:10px;top:-10px;left:50%;margin-left:-21px;background-size:100%;} @media (max-width:1440px){.smalltit026{margin-top: 30px!important;}}', // PC端样式
