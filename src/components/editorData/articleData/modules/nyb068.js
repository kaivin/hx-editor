...
export function getHtmlData (){
    return {
        ...
        styleWapCode:'.smalltxt068 p{position:relative;padding-left:.83986875rem} .smalltxt068 p:before{content:"";width:.0266875rem;border:1px dashed #8bb8ec;position:absolute;left:.3125rem;top: 0.44rem;bottom: -0.84rem;} .smalltxt068 p:last-child:before{display:none} .smalltxt068 p span{width:.6rem;height:.6rem;background:#336dc6;border-radius:50%;display:block;font-weight: normal;line-height: 0.6rem;color: #336dc6;padding-left: 0.12rem;position:absolute;left:0;top:.12rem;z-index:1;} .smalltxt068 p span:before{content:"";width:.48rem;height:.48rem;background:#fff;border-radius:50%;font-size:.4rem;color:#336dc6;font-weight:400;text-align:center;line-height:.48rem;display:block;position:absolute;left:0;top: 50%;margin-top: -0.24rem;z-index: -1;}', // 移动端样式
