...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt046{background:#eaf6ff;padding:15px;color:#2174b8;border:1px dashed #88c5f6;border-radius:10px;-webkit-box-shadow:0 0 70px rgba(33, 125, 200, 0.3) inset;box-shadow:0 0 70px rgba(33, 125, 200, 0.3) inset;margin-left:auto;margin-right:auto;}', // PC端样式
