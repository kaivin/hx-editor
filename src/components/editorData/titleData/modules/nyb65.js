...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'', // PC端样式
        styleWapCode:'.smalltit065{clear:both;display:block;position:relative;text-align:left}.smalltit065 strong{clear:both;display:inline-block;position:relative;padding-bottom:.26667rem}.smalltit065 strong:after,.smalltit065 strong:before{content:"";height:.06667rem;display:block;position:absolute;left:0}.smalltit065 strong:before{width:30%;background:#ffc773;bottom:.13333rem}.smalltit065 strong:after{width:60%;background:#fff2df;bottom:0rem}', // 移动端样式
