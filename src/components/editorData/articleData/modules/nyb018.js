 ...
 * @LastEditTime: 2020-06-08 18:07:59
...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt018{position:relative;border-radius:10px;border:1px dashed #84c584;z-index:10;padding:10px 15px !important;}.smalltxt018:before{content:"";border-radius:10px;position:absolute;left:5px;right:5px;bottom:5px;top:5px;background:#ceefce;z-index:-1;}', // PC端样式
