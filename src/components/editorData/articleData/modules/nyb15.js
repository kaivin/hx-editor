...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt015{position:relative; background:#ad7dbd; background:-webkit-linear-gradient(top, #ad7dbd, #581e67); color:#fff !important; padding:15px 20px !important; margin-bottom:20px;}.smalltxt015:before{content:""; position:absolute; left:5px; right:5px; top:5px; bottom:5px; border:1px solid #fff;}', // PC端样式
