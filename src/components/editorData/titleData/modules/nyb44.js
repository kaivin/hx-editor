...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'', // PC端样式
        styleWapCode:'.smalltit044{clear:both;display:block;position:relative;text-align:left}.smalltit044 strong{clear:both;display:inline-block;position:relative;padding-bottom:.26667rem}.smalltit044 strong:after,.smalltit044 strong:before{content:"";height:.06667rem;display:block;position:absolute;left:0}.smalltit044 strong:before{width:30%;background:#00a101;bottom:.13333rem}.smalltit044 strong:after{width:60%;background:#aee6b8;bottom:0rem}', // 移动端样式
