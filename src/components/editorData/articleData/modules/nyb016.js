export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt016{position:relative;background-size:100%;border-radius:5px;padding:15px !important;border:1px solid #333333;max-width:800px;margin-left:auto;margin-right:auto;}.smalltxt016:after, .smalltxt016:before{content:"";position:absolute;width:14px;height:10px;}.smalltxt016:after{background:url(../images/insidestyle/small009.png) no-repeat left top;right:40px;bottom:-5px;}.smalltxt016:before{background:url(../images/insidestyle/small010.png) no-repeat left top;left:40px;top:-5px;}', // PC端样式
