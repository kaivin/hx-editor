...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltext003 {padding:20px 15px 10px 15px !important;border-radius:10px;border:1px solid #82cbef;position:relative;margin-top:20px!important;margin-bottom:20px!important;}.smalltext003 strong {background:#82cbef;color:#fff;display:block;border-radius:18px;padding:5px 15px;line-height:24px;text-align:center;position:absolute;font-size:18px;left:50%;transform:translateX(-50%);top:-18px;}', // PC端样式
