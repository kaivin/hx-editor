...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltit033{clear:both;text-align:center;}.smalltit033 strong{display:inline-block;position:relative;border-top:1px solid #ff461f;border-bottom:1px solid #ff461f;padding:8px 0px 7px 0px;font-size:18px;}.smalltit033 strong span{position:absolute;left:50%;background:#fff;color:#ff461f;font-style:normal;width:26px;z-index:5;line-height:15px;font-size:18px;top:-7px;text-align:center;margin-left:-13px;}', // PC端样式
