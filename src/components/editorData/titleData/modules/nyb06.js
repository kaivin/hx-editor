...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltit006 { background: url(../images/insidestyle/newicon06.png) no-repeat left 7px; padding-left: 27px !important; background-size: 18px; }@media (min-width: 1366px) { .smalltit006 { background-position: left 12px; background-size: 20px; padding-left: 30px !important; }}@media (min-width: 1730px) { .smalltit006 { background-position: left 15px; background-size: 24px; padding-left: 35px !important; }}', // PC端样式
