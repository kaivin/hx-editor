...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt042{padding:10px 15px;background:#e5eefe;border-radius:10px;position:relative;z-index:2;margin-left: 5px!important;margin-right: 5px!important;margin-bottom: 25px!important;margin-top: 25px!important;}.smalltxt042:before{content:"";border:1px dashed #bcd0f5;border-radius:10px;left: -5px;right: -5px;top: -5px;bottom: -5px;position:absolute;z-index:-1;}', // PC端样式
