...
export function getHtmlData (){
    return{
        ...
        class:'smalltit029',// 用来给js使用添加页面内样式使用
        ...
        styleWapCode:'.smalltit029 strong{display:inline-block;position:relative;background:rgb(0,86,133)!important;padding:0rem 0.2rem 0rem 0.86667rem;border-radius:0.13333rem;color:#fff!important;font-weight:normal;}.smalltit029 strong span{position:absolute;top:-0.06667rem;bottom:-0.06667rem;background:rgb(199,237,251)!important;color:rgb(0,86,133)!important;font-style:normal;left:0.09333rem;width:0.64rem;z-index:5;border-radius:0.06667rem;line-height:0.84rem;font-size:0.38667rem;text-align:center;font-weight:bold;}', // 移动端样式
