...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltext011{clear:both; display:block; width:100%; border:1px dotted #c62929; padding:10px 20px 0px 20px; border-radius:10px; overflow:hidden; margin-bottom:20px;}.smalltext011 strong{clear:both; display:block; text-align:center; color:#c62929; padding-bottom:5px; font-size:18px;}.smalltext011 p{margin:0px;}', // PC端样式
