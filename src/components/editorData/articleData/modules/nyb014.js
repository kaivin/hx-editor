export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt014{position:relative;padding:15px 18px !important;border:1px solid #f6b37f;max-width:800px;margin-left:auto;margin-right:auto;}.smalltxt014:before{content:"";position:absolute;border-width:2px;border-color:#f6b37f;border-style:dashed;left:2px;top:2px;right:2px;bottom:2px;}.smalltxt014:after{content:"";position:absolute;border-width:1px;border-color:#f6b37f;border-style:solid;left:6px;top:6px;right:6px;bottom:6px;}', // PC端样式
