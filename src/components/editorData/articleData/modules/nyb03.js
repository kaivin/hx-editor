export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt003{position:relative; border:1px solid #f6b37f; padding:20px 20px !important; margin-bottom:20px;}.smalltxt003:before{content:""; position:absolute; border:1px #f6b37f dashed; left:5px; top:5px; right:5px; bottom:5px;}', // PC端样式
