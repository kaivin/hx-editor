export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt015{position:relative;padding: 15px;background-size:100%;background:-webkit-linear-gradient(top, #633434, #7b0000);color:#fff !important;}.smalltxt015:before{content:"";position:absolute;left:5px;right:5px;top:5px;bottom:5px;border:1px solid #fff;}', // PC端样式
