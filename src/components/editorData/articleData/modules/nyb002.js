export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt002{border:1px solid #88abda;padding:15px !important;box-shadow:0px 5px 0px #c0d3eb;max-width:800px;margin-left:auto;margin-right:auto;}', // PC端样式
