...
export function getHtmlData (){
    return{
        ...
        styleWapCode:'.smalltit031 strong{display:inline-block;position:relative;border: 1px solid rgb(0,86,133)!important;border-radius: 0.5rem;padding: 0.1rem 0.5rem 0.1rem 1.2rem;}.smalltit031 strong span{position:absolute;top:0px;background:rgb(1,102,155)!important;color:#ffffff;font-style:normal;left:0px;width: 0.95rem;height: 0.95rem;z-index:5;border-radius:50%;line-height: 0.9rem;font-weight:bold;text-align:center;}', // 移动端样式
