...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltxt016 {position:relative;border-radius:10px;border:1px solid #333333;padding:10px 15px !important;margin-bottom:20px!important;}.smalltxt016:after, .smalltxt016:before {content:"";position:absolute;width:14px;height:10px;}.smalltxt016:after {background:url(../images/insidestyle/small009.png) no-repeat left top;right:20px;bottom:-5px;background-size:100%;}.smalltxt016:before {background:url(../images/insidestyle/small010.png) no-repeat left top;left:20px;top:-5px;background-size:100%;}', // PC端样式
