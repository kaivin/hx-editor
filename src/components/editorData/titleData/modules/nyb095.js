...
export function getHtmlData (){
    return {
        ...
        styleWebCode:'.smalltit095{position:relative;z-index:1;}.smalltit095 strong{display:inline-block;border-radius:30px;padding:8px 20px;line-height:30px;position:relative;background:#3876da;color:#fff!important;font-size:18px;}', // PC端样式
