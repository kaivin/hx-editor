...
export function getHtmlData (){
    return {
        ...
        styleWapCode:'.smalltext023{background:#f5fbff;border:1px solid #a7d5f8;border-radius:0 .8rem 0 0;padding:0.4rem 0.4rem 0.2rem 0.4rem;position:relative;}.smalltext023:before{content:"";width:0.69333rem;height:0.88rem;background:url(../images/insidestyle/small045.gif) no-repeat center center;background-size:100%;position:absolute;left:-0.13333rem;top:0.21333rem;}.smalltext023 .smalltext023tit{text-align:center;margin:0px;}.smalltext023 .smalltext023tit strong{color:#3c87d7!important;display:inline-block;position:relative;z-index:1;font-size:0.42667rem;line-height:0.53333rem;padding:0.06667rem 0.13333rem;}.smalltext023 .smalltext023tit strong:before, .smalltext023 .smalltext023tit strong:after{content:"";width:0.4rem;height:0.4rem;border-radius:50%;display:block;position:absolute;z-index:-1;}.smalltext023 .smalltext023tit strong:before{background:#aadafe;left:-0.2rem;top:0;}.smalltext023 .smalltext023tit strong:after{border:2px dashed #aadafe;right:-0.2rem;bottom:0;}.smalltext023 p{margin:0.2rem 0rem 0rem 0rem;}', // 移动端样式
